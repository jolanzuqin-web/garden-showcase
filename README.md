...
[brandbook.html](brandbook.html) — дизайн-система проекта: логотип и знак, маскот «Гусь-смотритель» (концепт, промпты для генерации, граница антропоморфизма), цвет и сезонные темы, типографика, иконки, UI-компоненты, tone of voice. Открывается напрямую в браузере.
...
brandbook.html    — дизайн-система проекта
```
